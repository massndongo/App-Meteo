            ...
            <SafeAreaView className="flex flex-1">
                          ...
                          return (
                            <TouchableOpacity 
                              ...
                              className={"flex-row items-center border-0 p-3 px-4 mb-1 "+borderClass}>
                                ...
                                <Text className="text-black text-lg ml-2">{loc?.name}, {loc?.sys.country} tetxt</Text>
                            </TouchableOpacity>
                          )
                        })
                      }
              ...
              <View className="mx-4 flex justify-around flex-1 mb-2">
                ...
                <Text className="text-white text-center text-2xl font-bold"> gjdh
                  {location?.city.name}, <Text className="text-lg font-semibold text-gray-300">{location?.country}</Text>
                </Text>
                {/* weather icon */}
                ...
                <View className="space-y-2">
                    <Text className="text-center font-bold text-white text-6xl ml-5">{current?.temp_c}&#176; gjhdgh</Text>
