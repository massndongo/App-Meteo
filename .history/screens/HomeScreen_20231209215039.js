              ...
              <View className="mx-4 flex justify-around flex-1 mb-2">
                ...
                <View className="flex-row justify-center">
                  <Image 
                    ...
                    source={weatherImages[weather?.list[0].weather[0]. || 'other']} 
                    className="w-52 h-52" />
                ...
                <View className="space-y-2">
                  {weather?.wind ? (
                    <Text className="text-center font-bold text-white text-6xl ml-5">{weather.wind.deg}&#176;</Text>
                  ) : (
                    <Text className="text-center font-bold text-white text-6xl ml-5">N/A</Text>
                  )}
                  {weather?.weather && weather.weather[0]?.description ? (
                    <Text className="text-center text-white text-xl tracking-widest">{weather.weather[0].description}</Text>
                  ) : (
                    <Text className="text-center text-white text-xl tracking-widest">N/A</Text>
                  )}
                </View>
                ...
                <View className="flex-row justify-between mx-4">
                  <View className="flex-row space-x-2 items-center">
                    ...
                    <Text className="text-white font-semibold text-base">{weather?.wind}km</Text>
                  </View>
                  <View className="flex-row space-x-2 items-center">
                    <Image source={require('../assets/icons/drop.png')} className="w-6 h-6" />
                    <Text className="text-white font-semibold text-base">{weather?.humidity}%</Text>
                  </View>
                  <View className="flex-row space-x-2 items-center">
