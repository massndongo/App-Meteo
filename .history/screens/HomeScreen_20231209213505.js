            ...
            <SafeAreaView className="flex flex-1">
              ...
              <View className="mx-4 flex justify-around flex-1 mb-2">
                ...
                <Text className="text-white text-center text-2xl font-bold">
                  {weather?.city.name}, <Text className="text-lg font-semibold text-gray-300">{weather?.sys.country || weather?.city.country}</Text>
                </Text>
                {/* weather icon */}
                <View className="flex-row justify-center">
                  <Image 
                    // source={{uri: 'https:'+weather?.condition?.icon}} 
                    source={weatherImages[weather?.condition?.text || 'other']} 
                    className="w-52 h-52" />
                  
                </View>
                {/* degree celcius */}
                <View className="space-y-2">
                    <Text className="text-center font-bold text-white text-6xl ml-5">{weather?.temp_c}&#176;</Text>
                    <Text className="text-center text-white text-xl tracking-widest">{weather?.condition?.text}</Text>
                </View>
                ...
                <View className="flex-row justify-between mx-4">
                  <View className="flex-row space-x-2 items-center">
                    ...
                    <Text className="text-white font-semibold text-base">{weather?.wind_kph}km</Text>
                  </View>
                  <View className="flex-row space-x-2 items-center">
