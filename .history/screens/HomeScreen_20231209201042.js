            ...
            <SafeAreaView className="flex flex-1">
              ...
              <View className="mx-4 flex justify-around flex-1 mb-2">
                ...
                <View className="space-y-2">
                    <Text className="text-center font-bold text-white text-6xl ml-5">{current?.wind?.}&#176;</Text>
                    <Text className="text-center text-white text-xl tracking-widest">{current?.wind?.deg} hkfjdh</Text>
                </View>
